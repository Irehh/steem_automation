...
// const steemPrivateKey = process.env.STEEM_PRIVATE_KEY || "5JHY52X6HqVeVbCuxnT9JaeDaxAZJyTec6cEmzZJ2TbgmxaZgJU" // Your private posting key
...
//   // Try to find source link in various formats
//   const patterns = [
//     /Source\s*$$(https?:\/\/[^\s)]+)$$/i,
//     /Source:\s*(https?:\/\/[^\s)]+)/i,
//     /\bSource\b[^\n]*?(https?:\/\/[^\s)]+)/i,
...
//   // Look for URLs at the end of the message
...
//               5. Add "Follow our Steem account: @${steemAuthor}" ONLY ONCE at the end of the article.
...
//   // Add footer with single Steem account mention
//   const footer = `
